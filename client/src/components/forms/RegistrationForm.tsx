      ...
      {step === 2 && (
        <div className="space-y-6">
          <div className="text-center p-8 border-2 border-dashed rounded-lg">
            ...
            <button onClick={openCamera} className="bg-blue-500 text-white px-6 py-2 rounded-full hover:bg-blue-600">
              Open Camera
            </button>
            <video ref={videoRef} autoPlay className="w-full h-auto mt-4"></video>
            <canvas ref={canvasRef} className="hidden"></canvas>
            <button onClick={captureImage} className="bg-green-500 text-white px-6 py-2 mt-4 rounded-full hover:bg-green-600">
              Capture Image
            </button>
          </div>
          
          <div className="text-center p-8 border-2 border-dashed rounded-lg">
            <Fingerprint className="w-16 h-16 mx-auto mb-4 text-gray-400 cursor-pointer" onClick={startScan} />
            <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">
